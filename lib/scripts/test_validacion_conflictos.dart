...
class TestValidacionConflictos {
  static void ejecutarPruebas() {
    ...
    print('✅ Todas las pruebas de lógica de validación de conflictos han pasado correctamente.');
  }
  ...
  static void _probarValidacionHorarios() {
    ...
    final disponibilidadSlots = [
      {'dia': 'Lunes', 'horaInicio': '14:00', 'horaFin': '16:00', 'activo': true},
      {'dia': 'Martes', 'horaInicio': '09:00', 'horaFin': '11:00', 'activo': true},
      {'dia': 'Miércoles', 'horaInicio': '15:00', 'horaFin': '17:00', 'activo': true},
    ];
    ...
    for (final caso in casosPrueba) {
      ...
      print('${caso['descripcion']}: $estado (Esperado: ${caso['esperado']}, Obtenido: $resultado)');
    }
